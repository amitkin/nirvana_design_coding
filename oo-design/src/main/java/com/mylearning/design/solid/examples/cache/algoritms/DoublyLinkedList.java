package com.mylearning.design.solid.examples.cache.algoritms;

import java.util.NoSuchElementException;

import com.mylearning.design.solid.examples.cache.algoritms.exceptions.InvalidElementException;
