...
/*
TrafficController will issue the command for Roads and then all TrafficSignal are autonomous and independent
of each other to perform their job(since assigning task to TrafficSignal is handle by TrafficController).
This way if someone will add new Road or remove Road then it will follow open/closed principle along with change
is the traffic signal colors.
...
*/
public class TrafficControllerMain {
    ...
    public static void main(String[] args) {
        TrafficControllerMain trafficController = new TrafficControllerMain();
