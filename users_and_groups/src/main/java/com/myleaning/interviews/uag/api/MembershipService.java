package com.myleaning.interviews.uag.api;
...
public interface MembershipService {
     ...
     * If the user already belongs to that group, then the request is silently ignored.
     *
     ...
     * @throws IllegalArgumentException if either {@code user} or {@code group} does not exist according to the
     *                                  {@code UserService} and {@code GroupService}
     */
     ...
     * <p>
     * Users that are a member of the child group are transitively a member of any
     * parent groups for it.  For example, suppose we want things to look like this:
     * </p>
     * <pre><code>
     *        STUDENTS
     *        /      \
     ...
     * </code></pre>
     * <p>
     * A user assigned to the PHYSICS group inherits being in the SCIENCE and STUDENTS
     * groups as well.
     * </p>
     * <p>
     ...
     * If the user does not belong to that group, then the request is silently ignored.
     *
     ...
     * <p>
     * Note that this can only remove direct memberships.  If the child inherits from the
     * parent through another group, then this will not do anything.
     * </p>
     *
