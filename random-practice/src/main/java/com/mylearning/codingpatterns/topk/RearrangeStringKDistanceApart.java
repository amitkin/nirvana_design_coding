...
class RearrangeStringKDistanceApart {
    ...
    // We can follow a greedy approach to find an arrangement of the given string where no two same
    // Following a similar approach, since we were inserting a character back in the heap in the next iteration,
    // in this problem, we will re-insert the character after ‘K’ iterations. We can keep track of previous characters
    // in a queue to insert them back in the heap after ‘K’ iterations.
