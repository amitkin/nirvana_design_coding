...
/**
 * Given a graph with weighted edges, find shortest path from one vertex to all vertices
 *
...
public class DijkstraShortestPath {
    public Map<Vertex<Integer>,Integer> shortestPath(GraphGeneric<Integer> graph, Vertex<Integer> sourceVertex){
    ...
    public static void main(String args[]){
        GraphGeneric<Integer> graph = new GraphGeneric<>(false);
        /*graph.addEdge(0, 1, 4);
        graph.addEdge(1, 2, 8);
        graph.addEdge(2, 3, 7);
        graph.addEdge(3, 4, 9);
