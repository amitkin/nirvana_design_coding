package com.mylearning.geometry;
 ...
 * https://www.youtube.com/watch?v=vS4Zn1a9KUc - Coursera
...
public class ClosestPairOfPoints {
    ...
    static class XCoordinatorSorter implements Comparator<Point>{
        @Override
    ...
    static class YCoordinatorSorter implements Comparator<Point>{
        @Override
        public int compare(Point o1, Point o2) {
            if(o1.y < o2.y){
                return -1;
